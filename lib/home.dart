        ...
        child: Drawer(
          ...
          child: Container(
            decoration: BoxDecoration(
                border: Border(
                    right: BorderSide(color: Colors.blueAccent.shade700))),
            child: ListView(
              children: [
                DrawerHeader(
                  child: SizedBox(
                            ...
                            IconButton(
                                onPressed: () {
                                  _launchUrl(Uri.parse(
                                      'https://www.youtube.com/c/KorpsTarunaPOLTEKSSN'));
                                },
                                icon: FaIcon(FontAwesomeIcons.youtube,
                                    color: Colors.blueAccent.shade700,
                                    size: scrw * (smallVer ? 6 : 1.5))),
                            Padding(
                              padding: smallVer
                                  ? const EdgeInsets.symmetric(horizontal: 106)
                                  : const EdgeInsets.fromLTRB(10, 0, 0, 0),
                              child: IconButton(
                                  onPressed: () {
                                    _launchUrl(Uri.parse(
                                        'https://www.instagram.com/trojans_id'));
                                  },
